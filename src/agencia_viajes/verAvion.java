...
public class verAvion extends javax.swing.JFrame {
    ...
    public verAvion() {
        ...
        String titulos[]={"indice","Destino","Tipo transporte","Origen","Salida","Regreso","Pasaje","Precio","Clase","Aerolinea"};
        ...
        try{
            ...
            Avion h2[]= (Avion[]) ois.readObject( );
            ois.close();
            for(int i=0;i<h2.length;i++){
                tm.addRow(new Object[]{String.valueOf(i),h2[i].getdestino(),h2[i].gettipotra(),h2[i].getorigen(),h2[i].getfechaS(),h2[i].getfechaR(),String.valueOf(h2[i].getpas()),String.valueOf(h2[i].getprecio()),h2[i].tipoClase(),h2[i].aerolin()});

...
public class verHistorial extends javax.swing.JFrame {
    ...
    public verHistorial() {
        ...
        String titulos[]={"Nombre", "Tipo", "Cantidad comprada", "Total pagado","Fecha de compra"};
        ...
        try{
            ...
            if(archivo.exists()){
                ...
                for(int i=0;i<c2.length;i++){
                    if(c2[i].getCorreoC().equals(Sesion.getUsuarioActual().obtenerCorreo())){
                        ...
                        switch(tipo){
                            case "hotel":
                                ...
                                ois2.close();
                                tm.addRow(new Object[]{h2[c2[i].getId()].getnombre(),"hotel",c2[i].getCantidadC(),c2[i].getPagado(),c2[i].getFCompra()});
                            ...
                            case "bus":
                                ...
                                ois3.close();
                                tm.addRow(new Object[]{b2[c2[i].getId()].getorigen()+"-"+b2[c2[i].getId()].getdestino(),"bus",c2[i].getCantidadC(),c2[i].getPagado(),c2[i].getFCompra()});
                                jTaviones.setRowHeight(50);
                                break;
                            case "avion":
                                ...
                                ois4.close();
                                tm.addRow(new Object[]{a2[c2[i].getId()].getorigen()+"-"+a2[c2[i].getId()].getdestino(),"avion",c2[i].getCantidadC(),c2[i].getPagado(),c2[i].getFCompra()});
                                jTaviones.setRowHeight(50);
                                break;
                            case "crucero":
                                ...
                                ois5.close();
                                tm.addRow(new Object[]{cr2[c2[i].getId()].getorigen()+"-"+cr2[c2[i].getId()].getdestino(),"crucero",c2[i].getCantidadC(),c2[i].getPagado(),c2[i].getFCompra()});
                                jTaviones.setRowHeight(50);
                                break;
                            case "bh":
                                ...
                                ois6.close();
                                tm.addRow(new Object[]{bh2[c2[i].getId()].Mostrarviaje().getorigen()+"-"+bh2[c2[i].getId()].Mostrarviaje().getdestino()+"/Hote: "+bh2[c2[i].getId()].mostarh().getnombre(),"Bus_Hotel",c2[i].getCantidadC(),c2[i].getPagado(),c2[i].getFCompra()});
                                jTaviones.setRowHeight(50);
                                break;
                            case "vh":
                                ...
                                ois7.close();
                                tm.addRow(new Object[]{vh2[c2[i].getId()].Mostrarviaje().getorigen()+"-"+vh2[c2[i].getId()].Mostrarviaje().getdestino()+"/Hote: "+vh2[c2[i].getId()].mostarh().getnombre(),"Vuelo_Hotel",c2[i].getCantidadC(),c2[i].getPagado(),c2[i].getFCompra()});
                                jTaviones.setRowHeight(50);
                                break;
                        }
                    }
                ...
                JLabel no = new JLabel("Aun no has hecho compras");
                avionPanel.add(no);

...
public class Ibus extends javax.swing.JFrame {
    byte[] fileBytes;
    String imagePath = "sinfoto.png";
    /**
     * Creates new form Ibus
     */
    public Ibus() {
        initComponents();
        loadImage();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Ingresar Autobus");
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jSpasaje, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jTcompania, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Bus b1=new Bus(destino,origen,salida,regreso,pasaje,precio,fileBytes,clase,compania);
        Bus buses[]={b1};
        try {
            File archivo = new File("Buses.txt");
            if (!archivo.exists()) {
                try {
                    FileOutputStream fs = new FileOutputStream("Buses.txt");
                    ObjectOutputStream os = new ObjectOutputStream(fs);
                    os.writeObject(buses);
                    os.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ibus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
